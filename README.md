...
<p align="left"><b>Example Usage :</b><br>
```html
...
```
#### where : taxonomy database (--dbtaxonomy) contains k2_standard_16gb (default), 16S_RDP, 16S_SILVA138, 16S_Greengenes2, ncbi_16S_18S</p>
